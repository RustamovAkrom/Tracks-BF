...
class AuthAPITestCase(APITestCase):
    ...
    def setUp(self):
        # Создаём активного, но не верифицированного пользователя
    ...
    # ------------------- Forgot Password -------------------
    @patch("apps.users.api_endpoints.auth.security.forgot_password.views.send_password_reset_email")
    def test_forgot_password_success(self, mock_send_mail):
        ...
        mock_send_mail.assert_called_once()  # проверяем, что функция была вызвана
    ...
    def test_reset_password_success(self):
        ...
        # Проверяем, что пароль реально обновился
    ...
    def test_reset_password_expired_token(self):
        ...
        user_token = UserToken.objects.create(user=self.user, token_type="reset", is_used=False)
