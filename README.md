# 1️⃣ Скачиваем Python 3.11

Перейди на официальный сайт: https://www.python.org/downloads/release/python-31113/

Скачай Windows installer (x64 если у тебя 64-битная система).

Во время установки обязательно отметь галочку “Add Python to PATH”.

Выбери установку для всех пользователей или для себя — не критично.
